...
# Define a job that checks for expired memberships
# @scheduler.scheduled_job('interval', days=1)
# def check_membership_expiration():
#     memberships = Membership.query.filter(Membership.expires_at <= datetime.now()).all()
#     for membership in memberships:
#         membership.fighterReady = False
#         db.session.commit()
